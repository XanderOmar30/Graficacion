...
export class canvasLocal {
  //---- Contexto para dibujar en el canvas
  private pincel: CanvasRenderingContext2D;
  
  //---- Tamaño de cada punto del QR
  private puntoSize: number;
  ...
  private generarQR(texto: string) {
    //---- Limpiamos el lienzo
